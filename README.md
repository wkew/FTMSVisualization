...
The example jupyter notebook - [5-Interactive FTMS and Visualisation.ipynb](#5-Interactive-FTMS-and-Visualisation.ipynb) - was originally written for Python 2 and may not work for Python 3.
